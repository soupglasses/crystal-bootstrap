...
The C++11 in this tree was generated by `crystal-to-cpp`, the transpiler in
crystal-bootstrap. The tree also contains runtime, pinned Crystal and shard
sources, and an offline native build driver. `SOURCE.json` records the target and
generation settings.
